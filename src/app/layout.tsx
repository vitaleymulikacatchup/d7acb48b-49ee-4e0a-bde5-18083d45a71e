...
export const metadata: Metadata = {
  title: "ICONICO - Premium Footwear Collection",
  description: "Step into style with ICONICO's premium shoe collection. Discover quality footwear that combines comfort, style, and craftsmanship for every occasion.",
  keywords: "premium shoes, footwear, sneakers, athletic shoes, dress shoes, ICONICO, quality footwear",
  metadataBase: new URL("https://iconico-store.com"),
  alternates: {
    canonical: "https://iconico-store.com"
  },
  openGraph: {
    title: "ICONICO - Premium Footwear Collection",
    description: "Step into style with ICONICO's premium shoe collection. Discover quality footwear that combines comfort, style, and craftsmanship.",
    siteName: "ICONICO",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/12252411/pexels-photo-12252411.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "ICONICO premium shoe collection"
      }
    ]
  },
  twitter: {
    ...
    title: "ICONICO - Premium Footwear Collection",
    description: "Step into style with ICONICO's premium shoe collection. Quality footwear for every occasion.",
    images: ["https://images.pexels.com/photos/12252411/pexels-photo-12252411.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
